          ...
          <div className="flex items-center gap-2">
            <div className="flex flex-1 flex-col gap-3">
              <div>
                ...
                >
                  <option value={CURRENT_LOCATION_HUB_ID}>My location</option>
                  {routeHubs.map((h) => (
...
export default function RouteIntelligencePage() {
  ...
  const origin = currentOriginHub ?? routeHubs.find((h) => h.id === originId) ?? routeHubs[0];
  const destination = routeHubs.find((h) => h.id === destinationId) ?? routeHubs[1];
  ...
  const handleOriginChange = useCallback((nextOriginId: string) => {
    if (nextOriginId === CURRENT_LOCATION_HUB_ID) {
          ...
          <div className="flex min-h-0 flex-col overflow-hidden border-l border-white/[0.06]">
            ...
            <div className="min-h-0 flex-1 overflow-y-auto">
              <PanelContent
                ...
                onSwap={() => { setOriginId(destinationId); setDestinationId(originId); }}
